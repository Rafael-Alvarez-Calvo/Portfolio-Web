...
// ── Tech icons — 3 clean zones, no overlaps ─────────────────────────────────
// Container ~500px wide x 540px tall | Photo ~340px centered
// LEFT col (left:1-3%) | RIGHT col (right:1-3%) | BOTTOM strip (bottom:3%)
...
const ICONS = [
  ...
  { label:"JavaScript", color:"#f7df1e", bg:"rgba(247,223,30,0.08)",  border:"rgba(247,223,30,0.28)",  delay:0.4, pos:{top:"15%", right:"1%"},
  ...
  { label:"Vite",       color:"#a855f7", bg:"rgba(168,85,247,0.08)",  border:"rgba(168,85,247,0.25)",  delay:1.6, pos:{top:"29%", right:"2%"},
  ...
  { label:"Jest",       color:"#c21325", bg:"rgba(194,19,37,0.08)",   border:"rgba(194,19,37,0.25)",   delay:2.0, pos:{top:"71%", right:"1%"},
  ...
  { label:"Webpack",    color:"#8dd6f9", bg:"rgba(141,214,249,0.07)", border:"rgba(141,214,249,0.22)",  delay:3.3, pos:{top:"85%", right:"2%"},
  ...
  // ─── BOTTOM STRIP: 4 icons spread, bottom:3%, clear of columns ──────────
  { label:"n8n",        color:"#ea4b71", bg:"rgba(234,75,113,0.08)",  border:"rgba(234,75,113,0.25)",  delay:0.9, pos:{bottom:"3%", left:"4%"},
  ...
  { label:"Claude AI",  color:"#d97706", bg:"rgba(217,119,6,0.08)",   border:"rgba(217,119,6,0.25)",   delay:2.2, pos:{bottom:"3%", left:"29%"},
  ...
  { label:"Git",        color:"#f05032", bg:"rgba(240,80,50,0.08)",   border:"rgba(240,80,50,0.25)",   delay:1.4, pos:{bottom:"3%", right:"29%"},
  ...
  { label:"Figma",      color:"#f24e1e", bg:"rgba(242,78,30,0.08)",   border:"rgba(242,78,30,0.25)",   delay:1.0, pos:{bottom:"3%", right:"4%"},
