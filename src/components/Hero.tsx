...
const ICONS = [
  ...
  { label:'React',       color:'#61dafb', bg:'rgba(97,218,251,0.08)',  border:'rgba(97,218,251,0.28)',  pos:{top:'18%', left:'14%'},   delay:0,
  ...
  { label:'TypeScript',  color:'#3178c6', bg:'rgba(49,120,198,0.1)',   border:'rgba(49,120,198,0.3)',   pos:{top:'32%', left:'12%'},   delay:1.2,
  ...
  { label:'Redux',       color:'#764abc', bg:'rgba(118,74,188,0.1)',   border:'rgba(118,74,188,0.28)',  pos:{top:'47%', left:'13%'},   delay:2.5,
  ...
  { label:'Formik',      color:'#0ea5e9', bg:'rgba(14,165,233,0.08)',  border:'rgba(14,165,233,0.25)',  pos:{top:'61%', left:'14%'},   delay:0.8,
  ...
  { label:'Node.js',     color:'#68a063', bg:'rgba(104,160,99,0.08)',  border:'rgba(104,160,99,0.25)',  pos:{top:'75%', left:'12%'},   delay:1.9,
  ...
  { label:'Bootstrap',   color:'#7952b3', bg:'rgba(121,82,179,0.08)',  border:'rgba(121,82,179,0.25)',  pos:{top:'40%', left:'10%'},  delay:3.1,
  ...
  // BOTTOM LEFT
  { label:'Sass',        color:'#cc6699', bg:'rgba(204,102,153,0.08)', border:'rgba(204,102,153,0.25)', pos:{bottom:'8%', left:'10%'},  delay:2.0,
  ...
  { label:'Zod',         color:'#3b82f6', bg:'rgba(59,130,246,0.08)',  border:'rgba(59,130,246,0.25)',  pos:{bottom:'4%', left:'26%'}, delay:1.3,
  ...
  { label:'JavaScript',  color:'#f7df1e', bg:'rgba(247,223,30,0.08)',  border:'rgba(247,223,30,0.28)',  pos:{top:'14%', right:'14%'},  delay:0.5,
  ...
  { label:'Vite',        color:'#a855f7', bg:'rgba(168,85,247,0.08)',  border:'rgba(168,85,247,0.25)',  pos:{top:'29%', right:'12%'},  delay:1.7,
  ...
  { label:'Tailwind',    color:'#38bdf8', bg:'rgba(56,189,248,0.08)',  border:'rgba(56,189,248,0.25)',  pos:{top:'44%', right:'13%'},  delay:2.8,
  ...
  { label:'Zustand',     color:'#a16207', bg:'rgba(161,98,7,0.08)',    border:'rgba(161,98,7,0.25)',    pos:{top:'59%', right:'14%'},  delay:0.4,
  ...
  { label:'Jest',        color:'#c21325', bg:'rgba(194,19,37,0.08)',   border:'rgba(194,19,37,0.25)',   pos:{top:'73%', right:'12%'},  delay:2.1,
  ...
  // FAR RIGHT
  { label:'Webpack',     color:'#8dd6f9', bg:'rgba(141,214,249,0.07)', border:'rgba(141,214,249,0.22)', pos:{top:'38%', right:'10%'}, delay:3.4,
  ...
  // BOTTOM RIGHT
  { label:'Git',         color:'#f05032', bg:'rgba(240,80,50,0.08)',   border:'rgba(240,80,50,0.25)',   pos:{bottom:'8%', right:'10%'},  delay:1.5,
  ...
  { label:'n8n',         color:'#ea4b71', bg:'rgba(234,75,113,0.08)',  border:'rgba(234,75,113,0.25)',  pos:{bottom:'3%', right:'26%'}, delay:0.9,
        ...
        <div className="hidden md:block relative" style={{ height:'540px' }}>
          ...
          <div className="absolute inset-0 flex items-end justify-center pointer-events-none">
            <div className="relative" style={{ width:'260px', height:'510px' }}>
              ...
              {/* Photo — transparent bg blends with dark hero */}
              <img src={rafaelPhoto} alt="Rafael Álvarez Calvo"
                className="relative z-10 w-full h-full object-contain object-bottom"
                style={{ filter:'drop-shadow(0 0 30px rgba(59,130,246,0.2)) drop-shadow(0 0 60px rgba(6,182,212,0.1)) brightness(1.02) contrast(1.03)' }}/>
              {/* Online */}
