...
// ── 18 tech icons with organic positions ─────────────────────────────────────
// pos: { top?, bottom?, left?, right? } — relative to the 580px×520px container
// avoid face zone: roughly top:5%–35%, left:30%–70% (center-top area)
const ICONS = [
  // LEFT SIDE — shoulder down
  { label:'React',       color:'#61dafb', bg:'rgba(97,218,251,0.08)',  border:'rgba(97,218,251,0.28)',  pos:{top:'18%', left:'2%'},   delay:0,
  ...
  { label:'TypeScript',  color:'#3178c6', bg:'rgba(49,120,198,0.1)',   border:'rgba(49,120,198,0.3)',   pos:{top:'32%', left:'0%'},   delay:1.2,
  ...
  { label:'Redux',       color:'#764abc', bg:'rgba(118,74,188,0.1)',   border:'rgba(118,74,188,0.28)',  pos:{top:'47%', left:'1%'},   delay:2.5,
  ...
  { label:'Formik',      color:'#0ea5e9', bg:'rgba(14,165,233,0.08)',  border:'rgba(14,165,233,0.25)',  pos:{top:'61%', left:'3%'},   delay:0.8,
  ...
  { label:'Node.js',     color:'#68a063', bg:'rgba(104,160,99,0.08)',  border:'rgba(104,160,99,0.25)',  pos:{top:'75%', left:'1%'},   delay:1.9,
  ...
  // FAR LEFT — more offset
  { label:'Bootstrap',   color:'#7952b3', bg:'rgba(121,82,179,0.08)',  border:'rgba(121,82,179,0.25)',  pos:{top:'40%', left:'-2%'},  delay:3.1,
  ...
  // BOTTOM LEFT
  { label:'Sass',        color:'#cc6699', bg:'rgba(204,102,153,0.08)', border:'rgba(204,102,153,0.25)', pos:{bottom:'8%', left:'8%'},  delay:2.0,
  ...
  { label:'Zod',         color:'#3b82f6', bg:'rgba(59,130,246,0.08)',  border:'rgba(59,130,246,0.25)',  pos:{bottom:'4%', left:'22%'}, delay:1.3,
  ...
  // RIGHT SIDE — shoulder down
  { label:'JavaScript',  color:'#f7df1e', bg:'rgba(247,223,30,0.08)',  border:'rgba(247,223,30,0.28)',  pos:{top:'14%', right:'2%'},  delay:0.5,
  ...
  { label:'Vite',        color:'#a855f7', bg:'rgba(168,85,247,0.08)',  border:'rgba(168,85,247,0.25)',  pos:{top:'29%', right:'0%'},  delay:1.7,
  ...
  { label:'Zustand',     color:'#a16207', bg:'rgba(161,98,7,0.08)',    border:'rgba(161,98,7,0.25)',    pos:{top:'59%', right:'2%'},  delay:0.4,
    svg:<svg viewBox="0 0 24 24" width="16" height="16" fill="none"><circle cx="12" cy="12" r="9" stroke="#a16207" strokeWidth="1.3"/><path d="M8 9h8M8 12h6M8 15h8" stroke="#a16207" strokeWidth="1.3" strokeLinecap="round"/></svg> },
  { label:'Jest',        color:'#c21325', bg:'rgba(194,19,37,0.08)',   border:'rgba(194,19,37,0.25)',   pos:{top:'73%', right:'1%'},  delay:2.1,
  ...
  // FAR RIGHT
  { label:'Webpack',     color:'#8dd6f9', bg:'rgba(141,214,249,0.07)', border:'rgba(141,214,249,0.22)', pos:{top:'38%', right:'-2%'}, delay:3.4,
  ...
  // BOTTOM RIGHT
  { label:'Git',         color:'#f05032', bg:'rgba(240,80,50,0.08)',   border:'rgba(240,80,50,0.25)',   pos:{bottom:'8%', right:'6%'},  delay:1.5,
  ...
  { label:'n8n',         color:'#ea4b71', bg:'rgba(234,75,113,0.08)',  border:'rgba(234,75,113,0.25)',  pos:{bottom:'3%', right:'22%'}, delay:0.9,
  ...
  // BOTTOM CENTER
  { label:'Claude AI',   color:'#d97706', bg:'rgba(217,119,6,0.08)',   border:'rgba(217,119,6,0.25)',   pos:{bottom:'14%', left:'36%'}, delay:2.6,
  ...
  { label:'Figma',       color:'#f24e1e', bg:'rgba(242,78,30,0.08)',   border:'rgba(242,78,30,0.25)',   pos:{top:'86%', left:'55%'},    delay:1.1,
      ...
      <div className="relative w-full max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        ...
        <div className="hidden md:block relative" style={{ height:'540px' }}>
          ...
          <div className="absolute inset-0 flex items-end justify-center pointer-events-none">
            <div className="relative" style={{ width:'240px', height:'510px' }}>
              {/* Corner brackets */}
              <div className="absolute top-4 left-0 w-5 h-5 border-t-2 border-l-2 border-cyan opacity-50"/>
              <div className="absolute top-4 right-0 w-5 h-5 border-t-2 border-r-2 border-cyan opacity-50"/>
              <div className="absolute bottom-8 left-0 w-5 h-5 border-b-2 border-l-2 border-blue opacity-50"/>
              <div className="absolute bottom-8 right-0 w-5 h-5 border-b-2 border-r-2 border-blue opacity-50"/>
              {/* Glow */}
              ...
              {/* Fades */}
              <div className="absolute bottom-0 left-0 right-0 h-28 z-20 pointer-events-none" style={{ background:'linear-gradient(to top, var(--bg) 15%, transparent 100%)' }}/>
              <div className="absolute inset-y-0 left-0 w-3 z-20 pointer-events-none" style={{ background:'linear-gradient(to right, var(--bg), transparent)' }}/>
              <div className="absolute inset-y-0 right-0 w-3 z-20 pointer-events-none" style={{ background:'linear-gradient(to left, var(--bg), transparent)' }}/>
              <div className="absolute top-0 left-0 right-0 h-6 z-20 pointer-events-none" style={{ background:'linear-gradient(to bottom, var(--bg), transparent)' }}/>
              {/* Tint */}
              <div className="absolute inset-0 z-10 pointer-events-none" style={{ background:'linear-gradient(160deg, rgba(59,130,246,0.06) 0%, transparent 50%, rgba(6,182,212,0.04) 100%)' }}/>
              {/* Scanline */}
              ...
              <img src={rafaelPhoto} alt="Rafael Álvarez Calvo" className="w-full h-full object-cover object-top" style={{ filter:'contrast(1.04) brightness(0.95) saturate(0.88)' }}/>
              {/* Online */}
