...
const ICONS = [
  // LEFT COLUMN
  { label:"React",      color:"#61dafb", bg:"rgba(97,218,251,0.08)",  border:"rgba(97,218,251,0.28)",  delay:0,   pos:{top:"15%", left:"14%"},
  ...
  { label:"Node.js",    color:"#68a063", bg:"rgba(104,160,99,0.08)",  border:"rgba(104,160,99,0.25)",  delay:1.8, pos:{top:"70%", left:"5%"},
  ...
  { label:"Bootstrap",  color:"#7952b3", bg:"rgba(121,82,179,0.08)",  border:"rgba(121,82,179,0.25)",  delay:3.0, pos:{top:"82%", left:"10%"},
  ...
  // RIGHT COLUMN
  { label:"JavaScript", color:"#f7df1e", bg:"rgba(247,223,30,0.08)",  border:"rgba(247,223,30,0.28)",  delay:0.4, pos:{top:"15%", right:"8%"},
  ...
  { label:"Vite",       color:"#a855f7", bg:"rgba(168,85,247,0.08)",  border:"rgba(168,85,247,0.25)",  delay:1.6, pos:{top:"29%", right:"7%"},
  ...
  { label:"Tailwind",   color:"#38bdf8", bg:"rgba(56,189,248,0.08)",  border:"rgba(56,189,248,0.25)",  delay:2.7, pos:{top:"43%", right:"1%"},
  ...
  { label:"Zustand",    color:"#ca8a04", bg:"rgba(202,138,4,0.08)",   border:"rgba(202,138,4,0.25)",   delay:0.3, pos:{top:"57%", right:"2%"},
  ...
  { label:"Jest",       color:"#c21325", bg:"rgba(194,19,37,0.08)",   border:"rgba(194,19,37,0.25)",   delay:2.0, pos:{top:"70%", right:"5%"},
  ...
  { label:"Webpack",    color:"#8dd6f9", bg:"rgba(141,214,249,0.07)", border:"rgba(141,214,249,0.22)",  delay:3.3, pos:{top:"82%", right:"10%"},
  ...
  // CENTER / FLOATING
  { label:"Claude AI",  color:"#d97706", bg:"rgba(217,119,6,0.08)",   border:"rgba(217,119,6,0.25)",   delay:2.2, pos:{top:"5%",  left:"32%"},
  ...
  { label:"Git",        color:"#f05032", bg:"rgba(240,80,50,0.08)",   border:"rgba(240,80,50,0.25)",   delay:1.4, pos:{top:"5%",  right:"33%"},
  ...
  { label:"n8n",        color:"#ea4b71", bg:"rgba(234,75,113,0.08)",  border:"rgba(234,75,113,0.25)",  delay:0.9, pos:{top:"25%", left:"28%"},
  ...
  { label:"Shopify",    color:"#96bf48", bg:"rgba(150,191,72,0.09)",  border:"rgba(150,191,72,0.28)",  delay:1.5, pos:{top:"40%", left:"19%"},
    svg:<svg viewBox="0 0 109 124" width="16" height="16"><path d="M74.7 14.8s-.3 0-.7.2c-.4-1.2-1.1-2.3-2-3.1-1-1-2.2-1.5-3.5-1.5-1 0-2 .3-2.9.8-.8-1-2-1.7-3.3-1.7-5.5 0-8.2 6.9-9 10.4-2.2.7-3.7 1.1-3.8 1.2-1.2.4-1.2.4-1.3 1.5-.1.9-3.4 26.1-3.4 26.1l27.6 4.8V14.8h-.7zm-8.5 2.6c-1.1.3-2.3.7-3.5 1.1.7-2.7 2-4.1 3.1-4.6.3 1.2.4 2.4.4 3.5zm-5.9-2.1c-1.4.5-2.9 1.8-3.8 4.7-.9.3-1.8.5-2.7.8.9-3.4 3-7 6.5-5.5zm2.8-3.8c.5 0 .9.2 1.3.5-2 .9-4.1 3.2-5 7.2l-3.8 1.2c1-3.7 3.4-8.9 7.5-8.9z" fill="#96bf48"/><path d="M74 14.8c-.4 0-.7.1-1.1.2L73 16c-.1 0-.5.1-1.1.3.3-1.2.8-2.3 1.5-3.1.6-.7 1.3-1.2 2-1.4.3 1.2.5 2.4.6 3zM45.4 52.2l3.7 1 .7-5.8-4.4 4.8zm27.3-37.4L76 53.3l-20.3-3.6v-2.1l15.5-28.8h1.5z" fill="#5e8e3e"/><path d="M76 53.3l-20.3-3.6V14.8L76 53.3z" fill="#96bf48"/></svg> },
  { label:"Figma",      color:"#f24e1e", bg:"rgba(242,78,30,0.08)",   border:"rgba(242,78,30,0.25)",   delay:1.0, pos:{top:"33%", right:"23%"},
      ...
      <div className="relative w-full max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        ...
        <div className="hidden md:block relative" style={{ height: "540px" }}>
          ...
          <div className="absolute inset-0 flex items-end justify-center pointer-events-none">
            ...
            >
              {/* Corner brackets */}
              <div className="absolute top-4 left-0 w-8 h-8 border-t-2 border-l-2 border-cyan opacity-60" />
              <div className="absolute top-4 right-0 w-8 h-8 border-t-2 border-r-2 border-cyan opacity-60" />
              <div className="absolute bottom-2 left-0 w-8 h-8 border-b-2 border-l-2 border-blue opacity-60" />
              <div className="absolute bottom-2 right-0 w-8 h-8 border-b-2 border-r-2 border-blue opacity-60" />
              {/* Floor glow */}
              <div
              ...
              <div
                ...
                style={{
                  background:
                    "radial-gradient(ellipse 60% 80% at 50% 40%, rgba(59,130,246,0.08) 0%, transparent 70%)",
                }}
              />
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(160deg, rgba(59,130,246,0.05) 0%, transparent 50%, rgba(6,182,212,0.04) 100%)",
                }}
              />
              {/* Scanline */}
              <div
              ...
              <img
                ...
                style={{
                  filter: "brightness(1.02) contrast(1.03) drop-shadow(0 0 20px rgba(59,130,246,0.2))",
                }}
              />
              {/* Online */}
