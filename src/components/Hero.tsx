...
const ICONS = [
  ...
  // ── BOTTOM ROW (safe — below body) ──
  {
    ...
    border: "rgba(204,102,153,0.25)",
    pos: { bottom: "3%", left: "10%" },
    delay: 2.0,
    svg: (
      <svg viewBox="0 0 24 24" width="16" height="16" fill="none">
        <circle cx="12" cy="12" r="9" stroke="#cc6699" strokeWidth="1.3" />
        <path
          d="M8 14c0 0 1.5 2 4 2s4-1.5 4-3.5-3-2.5-3-4S14.5 6 16 6"
          stroke="#cc6699"
          strokeWidth="1.3"
          strokeLinecap="round"
        />
      ...
      <div className="relative w-full max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        ...
        <div className="hidden md:block relative" style={{ height: "540px" }}>
          ...
          <div className="absolute inset-0 flex items-end justify-center pointer-events-none">
            <div
              className="relative"
              style={{ width: "260px", height: "510px" }}
            >
              {/* Corner brackets */}
              ...
              <img
                ...
                style={{
                  mixBlendMode: "screen",
                  filter:
                    "brightness(1.05) contrast(1.02) drop-shadow(0 0 25px rgba(59,130,246,0.25))",
                }}
              />
              {/* Online */}
